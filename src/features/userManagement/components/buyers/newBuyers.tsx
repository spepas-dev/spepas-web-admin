...
import { CreateBuyerDTO } from '../../types/buyer.types';
...
type FormValues = z.infer<typeof buyerSchema>;

interface NewBuyersProps {
  onSubmit: (buyer: CreateBuyerDTO) => void;
  loading?: boolean;
...
export function NewBuyers({ onSubmit, loading = false, selectedLocation }: NewBuyersProps) {
