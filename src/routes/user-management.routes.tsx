...
export const userManagementRoutes: RouteObject[] = [
            {
                path: ROUTE_PATHS.USER_MANAGEMENT.BASE, children: [
                    {index: true, element: <UsersPage />},
                    {path: ROUTE_PATHS.USER_MANAGEMENT.SELLER.BASE, children: [
                    ...
                    // ]},
                    {path: ROUTE_PATHS.USER_MANAGEMENT.RIDER.BASE, children: [
                        {index: true, element: <RidersPage />},
                        {path: ROUTE_PATHS.USER_MANAGEMENT.RIDER.VEHICLES.BASE, children: [
                            {index: true, element: <VehiclesPage />}
                        ]}
                    ]},
                    {path: ROUTE_PATHS.USER_MANAGEMENT.MECHANIC.BASE, children: [
                        {index: true, element: <MechanicsPage />}
                    ]},
                    {path: ROUTE_PATHS.USER_MANAGEMENT.GORO.BASE, children: [
                        {index: true, element: <GorosPage />}
                    ]},
                    {path: ROUTE_PATHS.USER_MANAGEMENT.PAYMENT_ACCOUNT.BASE, children: [
